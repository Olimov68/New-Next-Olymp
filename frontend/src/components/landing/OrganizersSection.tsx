...
export function OrganizersSection() {
  ...
  return (
    <section id="organizers" className="py-20 bg-background border-t border-border">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">{t("nav.organizers")}</h2>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
          {organizers.map((org) => (
            <Card key={org.name} className="group hover:shadow-2xl hover:shadow-indigo-500/10 hover:-translate-y-1 transition-all duration-300 border border-border bg-card backdrop-blur-sm text-center rounded-2xl">
