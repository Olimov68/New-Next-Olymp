...
export function HowItWorksSection() {
  ...
  return (
    <section id="how-it-works" className="relative py-24 overflow-hidden bg-background border-t border-border">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {currentSteps.map((step, i) => (
              <div key={i} className="relative flex flex-col items-center">
                {/* Step number */}
                <div className="relative z-10 flex h-12 w-12 items-center justify-center rounded-full bg-gradient-to-br from-blue-500 to-indigo-600 text-foreground font-bold text-lg shadow-lg shadow-blue-500/30 mb-6">
                  {i + 1}
                </div>

                {/* Card */}
                <div className="w-full rounded-2xl border border-border bg-card backdrop-blur-sm p-8 text-center hover:bg-accent hover:border-blue-400/30 transition-all duration-300 hover:-translate-y-1">
