          ...
          <div className="space-y-4 py-2">
            ...
            <div className="space-y-2">
              ...
              {form.options.map((opt, idx) => (
                <div key={opt.label} className={`flex items-center gap-3 rounded-xl border p-3 transition-colors ${opt.is_correct ? "border-green-500/30 bg-green-500/5" : "border-border"}`}>
                  <button
                    type="button"
