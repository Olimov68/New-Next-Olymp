...
export function RulesSection() {
  ...
  return (
    <section id="rules" className="py-20 bg-background border-t border-border">
      <div className="container mx-auto px-4 max-w-3xl">
        <div className="text-center mb-12">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">{t("nav.rules")}</h2>
        </div>

        <Accordion className="space-y-3">
          {rules.map((rule, i) => (
            <AccordionItem key={i} className="rounded-2xl border border-border bg-card backdrop-blur-sm shadow-lg px-6">
